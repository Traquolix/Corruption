 ...
 */
public class FrenzyReceptacleCommand extends Command {

    public static Point frenzyReceptaclePosition;

    /**
     * Constructs a new EffectCommand.
     */
    public FrenzyReceptacleCommand() {
        super("frenzy");
    ...
    private void execute(@NotNull CommandSender commandSender, @NotNull CommandContext commandContext) {
        ...
        if (frenzyReceptaclePosition == null) {
            logger.warn("Frenzy Receptacle Position is null");
        } else {
            Pos pos = new Pos(frenzyReceptaclePosition.x(), frenzyReceptaclePosition.y(), frenzyReceptaclePosition.z());
            player.teleport(pos.withY(pos.y() + 10));
        }
